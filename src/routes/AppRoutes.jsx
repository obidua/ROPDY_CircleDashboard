...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/mint/portfolios" element={<PlaceholderPage title="💼 Portfolios (All Slots)" description="View and manage all your active portfolios across different servers." />} />
